...
/*
    public Object getItemsFromOpenApi(SubwayRequest request) throws UnsupportedEncodingException {
//http://swopenapi.seoul.go.kr/api/subway/6a514b775a63716f39345544627262/json/realtimeStationArrival/0/5/%EC%82%AC%EB%8B%B9
        String url = "http://swopenapi.seoul.go.kr/api/subway/" + request.getKey() + "/realtimeStationArrival/0/5/" + request.getStation_nm();  //출력개수/역코드번호
